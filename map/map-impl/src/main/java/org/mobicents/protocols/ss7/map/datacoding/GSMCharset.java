...
public class GSMCharset extends Charset {
    ...
    public static final int[] BYTE_TO_CHAR_UrduAlphabetExtentionTable = { 0x0040, 0x00A3, 0x0024, 0x00A5, 0x00BF, 0x0022,
            ...
            0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, };
    // portuguese
    // http://www.3gpp.org/ftp/Specs/archive/23_series/23.038/23038-c00.zip
    // https://en.wikipedia.org/wiki/GSM_03.38
    public static final int[] BYTE_TO_CHAR_PortugueseAlphabet = { 0x0040, 0x00A3, 0x0024, 0x00A5, 0x00EA, 0x00E9, 0x00FA, 0x00ED,
            0x00F3, 0x00E7, 0x000A, 0x00D4, 0x00F4, 0x000D, 0x00C1, 0x00E1, 0x0394, 0x005F, 0x00AA,
            0x00C7, 0x00C0, 0x221E, 0x005E, 0x005C, 0x20AC, 0x00D3, 0x007C, 0x00A0, 0x00C2, 0x00E2,
            0x00CA, 0x00C9, 0x0020, 0x0021, 0x0022, 0x0023, 0x00BA, 0x0025, 0x0026, 0x0027, 0x0028,
            0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F, 0x0030, 0x0031, 0x0032, 0x0033,
            0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E,
            0x003F, 0x00CD, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, 0x0048, 0x0049,
            0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F, 0x0050, 0x0051, 0x0052, 0x0053, 0x0054,
            0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005A, 0x00C3, 0x00D5, 0x00DA, 0x00DC, 0x00A7,
            0x007E, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006A,
            0x006B, 0x006C, 0x006D, 0x006E, 0x006F, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075,
            0x0076, 0x0077, 0x0078, 0x0079, 0x007A, 0x00E3, 0x00F5, 0x0060, 0x00FC, 0x00E0};
    public static final  int[] BYTE_TO_CHAR_PortugueseAlphabetExtentionTable = { 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00EA, 0x0000, 0x0000, 0x0000, 0x00E7,
            0x000C, 0x00D4, 0x00F4, 0x000D, 0x00C1, 0x00E1, 0x0000, 0x0000, 0x03A6, 0x0393, 0x005E, 0x03A9, 0x03A0,
            0x03A8, 0x03A3, 0x0398, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00CA, 0x0000, 0x0000, 0x0000, 0x0000,
            0x0000, 0x0000, 0x0000, 0x0000, 0x007B, 0x007D, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x005C, 0x0000,
            0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x005B, 0x007E,
            0x005D, 0x0000, 0x007C, 0x00C0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00CD, 0x0000,
            0x0000, 0x0000, 0x0000, 0x0000, 0x00D3, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00DA, 0x0000, 0x0000,
            0x0000, 0x0000, 0x0000, 0x00C3, 0x00D5, 0x0000, 0x0000, 0x0000, 0x0000, 0x00C2, 0x0000, 0x0000, 0x0000,
            0x20AC, 0x0000, 0x0000, 0x0000, 0x00ED, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00F3, 0x0000, 0x0000,
            0x0000, 0x0000, 0x0000, 0x00FA, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00E3, 0x00F5, 0x0000, 0x0000, 0x00E2,};
}
